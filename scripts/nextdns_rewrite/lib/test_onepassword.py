...
class TestOnePasswordClient(unittest.TestCase):
    def test_get_field(self) -> None:
        def mock_op_item_get(*args: object, **kwargs: object) -> object:
            class MockResult:
    ...
    def test_get_field_with_backticks(self) -> None:
        def mock_op_item_get(*args: object, **kwargs: object) -> object:
            class MockResult:
    ...
    def test_get_field_with_tildes(self) -> None:
        def mock_op_item_get(*args: object, **kwargs: object) -> object:
            class MockResult:
    ...
    def test_get_fields_with_formatting(self) -> None:
        def mock_op_item_get(*args: object, **kwargs: object) -> object:
            class MockResult:
                stdout = (
                    '[{"label": "field1", "value": "```secret1```"}, {"label": "field2", "value": "~~~secret2~~~"}]'
                )
                stderr = ""
